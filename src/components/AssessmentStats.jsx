import totalAssessment from "../svgs/totalAssessment.svg";
import userIcon from "../svgs/userIcon.svg";
import verticalStroke from "../svgs/verticalStroke.svg";
import candidateSource from "../svgs/candidateSource.svg";
import shareIcon from "../svgs/shareIcon.svg";
import '../styles/style.css';
function AssessmentStats({showStats}) {
  return (
    <div>
    <div className="assessmentStats">
      <div className="mainPanel-heading">Assessments Overview</div>
      ...
      {(showStats)?<><div className="assessmentStatsOverview mobile-view">
